...
enum piscsi64_stuff {
  ...
  PISCSI64_MAX_BLOCK_SIZE = 65536,
  PISCSI64_TRACK_SECTORS = 2048,
};

#define PISCSI64_CMD_BACKEND_INFO 0x94
#define PISCSI64_BACKEND_INFO_PREFIX_MASK 0x0000000Fu
#define PISCSI64_BACKEND_INFO_MEDIA_MASK  0x00000030u
#define PISCSI64_BACKEND_INFO_MEDIA_SHIFT 4u
#define PISCSI64_BACKEND_INFO_REMOTE      0x00000040u

enum piscsi64_prefix_type {
    PISCSI64_PREFIX_UNKNOWN = 0,
    PISCSI64_PREFIX_DISK,
    PISCSI64_PREFIX_CDROM,
    PISCSI64_PREFIX_FLOPPY,
    PISCSI64_PREFIX_ZIP,
    PISCSI64_PREFIX_USB,
    PISCSI64_PREFIX_MAX = PISCSI64_PREFIX_USB,
};

enum piscsi64_cmds {
  PISCSI64_CMD_WRITE = 0x00,
  PISCSI64_CMD_READ = 0x02,
  PISCSI64_CMD_DRVNUM = 0x04,
  PISCSI64_CMD_DRVTYPE = 0x06,
  PISCSI64_CMD_BLOCKS = 0x08,
  PISCSI64_CMD_CYLS = 0x0A,
  PISCSI64_CMD_HEADS = 0x0C,
  PISCSI64_CMD_SECS = 0x0E,
  PISCSI64_CMD_ADDR1 = 0x10,
  PISCSI64_CMD_ADDR2 = 0x14,
  PISCSI64_CMD_ADDR3 = 0x18,
  PISCSI64_CMD_ADDR4 = 0x1C,
  PISCSI64_CMD_DEBUGME = 0x20,
  PISCSI64_CMD_DRIVER = 0x40,
  PISCSI64_CMD_NEXTPART = 0x44,
  PISCSI64_CMD_GETPART = 0x48,
  PISCSI64_CMD_GETPRIO = 0x4C,
  PISCSI64_CMD_WRITE64 = 0x50,
  PISCSI64_CMD_READ64 = 0x52,
  PISCSI64_CMD_CHECKFS = 0x60,
  PISCSI64_CMD_NEXTFS = 0x64,
  PISCSI64_CMD_COPYFS = 0x68,
  PISCSI64_CMD_FSSIZE = 0x6C,
  PISCSI64_CMD_SETFSH = 0x70,
  PISCSI64_CMD_BLOCKSIZE = 0x74,
  PISCSI64_CMD_READBYTES = 0x78,
  PISCSI64_CMD_WRITEBYTES = 0x7C,
  PISCSI64_CMD_DRVNUMX = 0x80,
  PISCSI64_CMD_LOADFS = 0x84,
  PISCSI64_CMD_GET_FS_INFO = 0x88,
  PISCSI64_CMD_MEDIA_EJECT = 0x8C,
  PISCSI64_CMD_MEDIA_INSERT = 0x90,
  PISCSI64_DBG_MSG = 0x1000,
  PISCSI64_DBG_VAL1 = 0x1010,
  PISCSI64_DBG_VAL2 = 0x1014,
  PISCSI64_DBG_VAL3 = 0x1018,
  PISCSI64_DBG_VAL4 = 0x101C,
  PISCSI64_DBG_VAL5 = 0x1020,
  PISCSI64_DBG_VAL6 = 0x1024,
  PISCSI64_DBG_VAL7 = 0x1028,
  PISCSI64_DBG_VAL8 = 0x102C,
  PISCSI64_CMD_ROM = 0x4000,
};

enum piscsi64_dbg_msgs {
  DBG_INIT,
  DBG_OPENDEV,
  DBG_CLOSEDEV,
  DBG_CHS,
