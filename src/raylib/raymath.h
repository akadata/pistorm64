...
//#define RAYMATH_STANDALONE        // NOTE: To use raymath as standalone lib, just uncomment this
//line #define RAYMATH_HEADER_ONLY       // NOTE: To compile functions as static inline, uncomment
//this line
...
RMDEF float Remap(float value, float inputStart, float inputEnd, float outputStart,
                  float outputEnd) {
...
RMDEF Matrix MatrixFrustum(double left, double right, double bottom, double top, double near,
                           double far) {
  Matrix result = {0};
...
RMDEF Matrix MatrixOrtho(double left, double right, double bottom, double top, double near,
                         double far) {
  Matrix result = {0};
