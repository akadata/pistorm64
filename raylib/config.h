...
//------------------------------------------------------------------------------------
// Camera module is included (camera.h) and multiple predefined cameras are available: free, 1st/3rd
// person, orbital
...
// Use a partial-busy wait loop, in this case frame sleeps for most of the time, but then runs a
// busy loop at the end for accuracy
...
// Support saving binary data automatically to a generated storage.data file. This file is managed
// internally.
#define SUPPORT_DATA_STORAGE 1
// Support automatic generated events, loading and recording of those events when required
//#define SUPPORT_EVENTS_AUTOMATION     1
// Support custom frame control, only for advance users
// By default EndDrawing() does this job: draws everything + SwapScreenBuffer() + manage frame
// timming + PollInputEvents() Enabling this flag allows manual control of the frame processes, use
// at your own risk
...
//------------------------------------------------------------------------------------
// Default font is loaded on window initialization to be available for the user to render simple
// text NOTE: If enabled, uses external module functions to load default raylib font
