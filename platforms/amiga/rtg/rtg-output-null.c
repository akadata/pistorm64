...
void rtg_set_cursor_clut_entry(uint8_t r, uint8_t g, uint8_t b, uint8_t idx) { (void)r; (void)g; (void)b; (void)idx; }
void rtg_set_mouse_cursor_image(uint8_t *src, uint8_t w, uint8_t h) { (void)src; (void)w; (void)h; }
void rtg_show_fps(uint8_t enable) { (void)enable; }
void rtg_set_scale_mode(uint16_t scale_mode) { (void)scale_mode; }
uint16_t rtg_get_scale_mode(void) { return 0; }
void rtg_set_scale_rect(uint16_t scale_mode, int16_t x1, int16_t y1, int16_t x2, int16_t y2) { (void)scale_mode; (void)x1; (void)y1; (void)x2; (void)y2; }
...
uint16_t rtg_get_scale_filter(void) { return 0; }
