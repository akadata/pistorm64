  ...
  case AHI_CMD_PLAY: {
    ...
    if (ahi_u32[0] != 0 && ahi_addr[0] != 0) {
      ...
      sprintf(dbgbuf,
              ...
              ahi_u32[0], hz, ahi_u32[1], (ahi_addr[1] >> 16), ahi_u32[2], bsize, ahi_u32[3]);
      ...
      while (sndbuf_offset >= old_sndbuf_offset + buff_size) {
        ...
        if (old_sndbuf_offset >= 127 * SIZE_KILO) {
          // printf("Buffer wrap.\n");
          memcpy(shitbuf, bufptr + (sndbuf_offset % buff_size),
                 bsize - (sndbuf_offset % buff_size));
...
void print_ahi_sample_type(uint16_t type) {
  switch (type) {
  case AHIST_M8S:
    printf("8-bit signed [Mono]");
    break;
  case AHIST_S8S:
    printf("8-bit signed [Stereo]");
    break;
  case AHIST_M16S:
    printf("16-bit signed [Mono]");
    break;
  case AHIST_S16S:
    printf("16-bit signed [Stereo]");
    break;
  case AHIST_M32S:
    printf("32-bit signed [Mono]");
    break;
  case AHIST_S32S:
    printf("32-bit signed [Stereo]");
    break;
  default:
    printf("UNKNOWN FORMAT (%d)", type);
  }
}
...
void print_ahi_debugmsg(int val, int type) {
  switch (val) {
  case 1:
    printf("[PI-AHI-amiga] Called INIT. Dev: %.8X\n", ahi_u32[0]);
    break;
  case 101:
    printf("[PI-AHI-amiga] !!!INIT: AHISubBase already set.\n");
    break;
  case 102:
    printf("[PI-AHI-amiga] Allocating driver base.\n");
    break;
  case 103:
    printf("[PI-AHI-amiga] Opening libraries.\n");
    break;
  case 104:
    printf("[PI-AHI-amiga] Init done.\n");
    break;

  case 2:
    printf("[PI-AHI-amiga] Called OPEN.\n");
    break;
  case 201:
    printf("[PI-AHI-amiga] OPEN: Set AHISubBase.\n");
    break;

  case 3:
    printf("[PI-AHI-amiga] Called CLOSE.\n");
    break;
  case 4:
    printf("[PI-AHI-amiga] Called BEGINIO (but how!?).\n");
    break;
  case 5:
    printf("[PI-AHI-amiga] Called ABORTIO (but how!?).\n");
    break;
  case 6:
    printf("[PI-AHI-amiga] Called ALLOCAUDIO.\n");
    break;
  case 601:
    printf("[PI-AHI-amiga] Allocating %d bytes for DriverData.\n", ahi_u32[0]);
    break;
  case 602:
    printf("[PI-AHI-amiga] Setting mixing frequency to %d.\n", ahi_u16[0]);
    break;
  case 603:
    printf("[PI-AHI-amiga] Setting up crap for the slave process.\n");
    break;
  case 604:
    printf("[PI-AHI-amiga] Find tasks and stuff.\n");
    break;
  case 605:
    printf("[PI-AHI-amiga] Forbidding and creating slace process. ahi-data = %.8X\n", ahi_u32[0]);
    break;
  case 606:
    printf("[PI-AHI-amiga] Slave process created.\n");
    break;
  case 607:
    printf("[PI-AHI-amiga] Permitting and moving on.\n");
    break;
  case 608:
    printf("[PI-AHI-amiga] Setting some crap for the slave process.\n");
    break;
  case 609:
    printf("[PI-AHI-amiga] Setting owner flags.\n");
    break;
  case 610:
    printf("[PI-AHI-amiga] Done with slave process stuff, resuming.\n");
    break;

  case 7:
    printf("[PI-AHI-amiga] Called FREEAUDIO.\n");
    break;
  case 8:
    printf("[PI-AHI-amiga] Called START.\n");
    break;
  case 81:
    printf("[PI-AHI-amiga] Buffer type: ");
    PRINT_AHI_SAMPLE_TYPE(ahi_u16[0]);
    printf(" Buffer size: %d\n", ahi_u32[0]);
    break;
  case 82:
    printf("[!!!PI-AHI-amiga] Out of memory allocating soft interrupts!\n");
    break;

  case 9:
    printf("[PI-AHI-amiga] Called STOP.\n");
    break;
  case 91:
    printf("[PI-AHI-amiga] Free Play SoftInt.\n");
    break;
  case 92:
    printf("[PI-AHI-amiga] Free Mix SoftInt.\n");
    break;
  case 93:
    printf("[PI-AHI-amiga] Free buffers.\n");
    break;
  case 94:
    printf("[PI-AHI-amiga] Free loop %d...\n", ahi_u32[0] + 1);
    break;

  case 10:
    printf("[PI-AHI-amiga] Called GETATTR.\n");
    break;
  case 1001:
    printf("[PI-AHI-amiga] Attr: %.8X Arg: %.8X Def: %.8X.\n", ahi_u32[0], ahi_u32[1], ahi_u32[2]);
    break;
  case 1002:
    printf("[PI-AHI-amiga] Query Bits.\n");
    break;
  case 1003:
    printf("[PI-AHI-amiga] Query NumFrequencies.\n");
    break;
  case 1004:
    printf("[PI-AHI-amiga] Get Frequency (index).\n");
    break;
  case 1005:
    printf("[PI-AHI-amiga] Index Frequency.\n");
    break;
  case 1006:
    printf("[PI-AHI-amiga] Query Author.\n");
    break;
  case 1007:
    printf("[PI-AHI-amiga] Query Copyright.\n");
    break;
  case 1008:
    printf("[PI-AHI-amiga] Query Version.\n");
    break;
  case 1009:
    printf("[PI-AHI-amiga] Query Annotation.\n");
    break;
  case 1010:
    printf("[PI-AHI-amiga] Query Recording capability.\n");
    break;
  case 1011:
    printf("[PI-AHI-amiga] Query Full Duplex.\n");
    break;
  case 1012:
    printf("[PI-AHI-amiga] Query Realtime.\n");
    break;
  case 1013:
    printf("[PI-AHI-amiga] Query MaxChannels.\n");
    break;
  case 1014:
    printf("[PI-AHI-amiga] Query MaxPlaySamples.\n");
    break;
  case 1015:
    printf("[PI-AHI-amiga] Query MaxRecordSamples.\n");
    break;
  case 1016:
    printf("[PI-AHI-amiga] Query MinMonitorVolume.\n");
    break;
  case 1017:
    printf("[PI-AHI-amiga] Query MaxMonitorVolume.\n");
    break;
  case 1018:
    printf("[PI-AHI-amiga] Query MinInputGain.\n");
    break;
  case 1019:
    printf("[PI-AHI-amiga] Query MaxInputGain.\n");
    break;
  case 1020:
    printf("[PI-AHI-amiga] Query MinOutputVolume.\n");
    break;
  case 1021:
    printf("[PI-AHI-amiga] Query MaxOutputVolume.\n");
    break;
  case 1022:
    printf("[PI-AHI-amiga] Query Inputs.\n");
    break;
  case 1023:
    printf("[PI-AHI-amiga] Query Input (index).\n");
    break;
  case 1024:
    printf("[PI-AHI-amiga] Query Outputs.\n");
    break;
  case 1025:
    printf("[PI-AHI-amiga] Query Output (index).\n");
    break;
  case 1099:
    printf("[!!!PI-AHI-amiga] GETATTR: Hit default case!\n");
    break;

  case 11:
    printf("[PI-AHI-amiga] Called HARDWARECONTROL.\n");
    break;
  case 1101:
    printf("[PI-AHI-amiga] Set MonitorVolume.\n");
    break;
  case 1102:
    printf("[PI-AHI-amiga] Query MonitorVolume.\n");
    break;
  case 1103:
    printf("[PI-AHI-amiga] Set InputGain.\n");
    break;
  case 1104:
    printf("[PI-AHI-amiga] Query InputGain.\n");
    break;
  case 1105:
    printf("[PI-AHI-amiga] Set OutputVolume.\n");
    break;
  case 1106:
    printf("[PI-AHI-amiga] Query OutputVolume.\n");
    break;
  case 1107:
    printf("[PI-AHI-amiga] Set Input.\n");
    break;
  case 1108:
    printf("[PI-AHI-amiga] Query Input.\n");
    break;
  case 1109:
    printf("[PI-AHI-amiga] Set Output.\n");
    break;
  case 1110:
    printf("[PI-AHI-amiga] Query Output.\n");
    break;
  case 1199:
    printf("[!!!PI-AHI-amiga] HARDWARECONTROL: Hit default case!\n");
    break;

  case 12:
    printf("[PI-AHI-amiga] Called SETEFFECT.\n");
    break;

  case 13:
    printf("[PI-AHI-amiga] Called LOADSOUND.\n");
    break;
  case 131:
    printf("[PI-AHI-amiga] Sound: %d Type: ", ahi_u16[0]);
    switch (ahi_u32[0]) {
    case AHIST_SAMPLE:
      printf("Sample");
      break;
    case AHIST_DYNAMICSAMPLE:
      printf("Dynamic Sample");
      break;
    case AHIST_INPUT:
      printf("Input!?");
      break;
    default:
      printf("UNKNOWN TYPE %d", ahi_u32[0]);
      break;
    }
    printf(" Info: %.8X\n", ahi_u32[1]);
    break;
  case 132:
    printf("[PI-AHI-amiga] Called UNLOADSOUND.\n");
    break;
  case 133:
    printf("[PI-AHI-amiga] Sound: %d\n", ahi_u16[0]);
    break;
  case 134:
    printf("[PI-AHI-amiga] Buffer type: ");
  ...
  case 14:
    printf("[PI-AHI-amiga] Called ENABLE.\n");
    break;
  case 141:
    printf("[PI-AHI-amiga] Enable()\n");
    break;

  case 15:
    printf("[PI-AHI-amiga] Called DISABLE.\n");
    break;
  case 151:
    printf("[PI-AHI-amiga] Disable()\n");
    break;

  case 16:
    printf("[PI-AHI-amiga] Called UPDATE.\n");
    break;

  case 17:
    printf("[PI-AHI-amiga] Called SETVOL.\n");
    break;
  case 171:
  ...
  case 18:
    printf("[PI-AHI-amiga] Called SETFREQ.\n");
    break;
  case 181:
  ...
  case 19:
    printf("[PI-AHI-amiga] Called SETSOUND.\n");
    break;
  case 191:
    printf("[PI-AHI-amiga] Channel: %d Sound: %d Offset: %d Length: %d Flags: %.8X\n", ahi_u16[0],
           ahi_u32[0], ahi_u32[1], ahi_u32[2], ahi_u32[3]);
    break;
  case 192:
  ...
  case 20:
    ...
    break;
  case 2001:
    printf("[PI-AHI-amiga] SLAVE:PlaySignal. BuffSamples: %d\n", ahi_u32[0]);
    break;
  case 2002:
    printf("[PI-AHI-amiga] SLAVE:MixSignal\n");
    break;
  case 2004:
    printf("[PI-AHI-amiga] SLAVE:Waiting for signal\n");
    break;
  case 2005:
    printf("[PI-AHI-amiga] SLAVE:PlaySignal End\n");
    break;
  case 2006:
    printf("[PI-AHI-amiga] SLAVE:Failed to allocate signals?\n");
    break;

  case 21:
    printf("[PI-AHI-amiga] Called PLAYFUNC.\n");
    break;
  case 22:
    printf("[PI-AHI-amiga] Called MIXFUNC.\n");
    break;

  // Debug messages of dubious usefulness
  case 998:
    printf("[!!!PI-AHI-amiga] NULL function called!\n");
    break;
  case 999:
    printf("[!!!PI-AHI-amiga] EXPUNGE called!\n");
    break;
  default:
