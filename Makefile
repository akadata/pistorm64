...
MUSASHI_REF_TEST_MODE ?= quick
MUSASHI_REF_TEST_ITERATIONS ?= 100
...
$(MUSASHI_REF_TEST_DRIVER): tools/musashi_ref_test_driver.c tools/musashi_ref_test_stubs.c src/musashi/m68kcpu.c src/musashi/m68kdasm.c src/musashi/m68kops.c src/musashi/softfloat/softfloat.c src/musashi/softfloat/softfloat_fpsp.c
	...
	$(CC) $(EMU_WARNINGS) $(OPT_LEVEL) $(CPUFLAGS) $(DEFINES) -I. -Isrc -Isrc/musashi \
		-o $@ tools/musashi_ref_test_driver.c tools/musashi_ref_test_stubs.c \
		src/musashi/m68kcpu.c src/musashi/m68kdasm.c src/musashi/m68kops.c \
		src/musashi/softfloat/softfloat.c src/musashi/softfloat/softfloat_fpsp.c -lm

musashi-ref-tests: $(MUSASHI_REF_TEST_DRIVER)
	tools/run_musashi_ref_tests.sh \
		--driver "$(MUSASHI_REF_TEST_DRIVER)" \
		--tests-root "$(MUSASHI_REF_TEST_ROOT)" \
		--mode "$(MUSASHI_REF_TEST_MODE)" \
		--cpu "$(MUSASHI_REF_TEST_CPU)" \
...
stage1-680x0-ci: musashi-ref-tests-quick musashi-ref-tests-68040-ci
	@echo "stage1-680x0-ci complete"
